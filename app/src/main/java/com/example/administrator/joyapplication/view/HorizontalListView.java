package com.example.administrator.joyapplication.view;
...
public class HorizontalListView extends AdapterView<ListAdapter>{
     ...
     */
        ...
        /**
         * DatasetObserver当数据集改变或者无效时，就会回调相应的函数做出处理，而典型的数据集
         就是cursor或者adapters.
        ...
        private void fillListRight(int rightEdge, final int dx) {
            while (rightEdge + dx < getWidth() && mRightViewIndex < mAdapter.getCount()) {
                ...
                View child = mAdapter.getView(mRightViewIndex, mRemovedViewQueue.poll(),
                        this);
        ...
        private void fillListLeft(int leftEdge, final int dx) {
            while (leftEdge + dx > 0 && mLeftViewIndex >= 0) {
                View child = mAdapter.getView(mLeftViewIndex, mRemovedViewQueue.poll(),
                        this);
                    ...
                    if (viewRect.contains((int) e.getX(), (int) e.getY())) {
                        ...
                        if (mOnItemSelected != null) {
                            mOnItemSelected.onItemSelected(HorizontalListView.this, child,
                                    mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex
                                            + 1 + i));
                        }
                        break;
                    }
